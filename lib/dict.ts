...
const en = {
  ...
  course: {
    ...
    unlock: "Unlock",
    unlocking: "Checking…",
    codeError: "That code isn't valid or has expired.",
...
const ar: typeof en = {
  ...
  course: {
    ...
    haveCode: "عندك كود وصول؟",
    codePlaceholder: "اكتب كود الوصول",
    unlock: "افتح",
    unlocking: "بيتأكّد…",
    codeError: "الكود غير صحيح أو انتهت صلاحيته.",
    unlockedTag: "تم الفتح ✓",
