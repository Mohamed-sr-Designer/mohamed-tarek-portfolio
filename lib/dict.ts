...
const en = {
  ...
  hero: {
    ...
    l1: "The designer brands",
    l2: "call when they need",
    l3pre: "to be",
    l3accent: "unforgettable.",
  ...
  recs: {
    ...
    h2a: "What the people who",
    h2i: "worked with me",
    h2b: " say.",
    note: "{n} recommendations written on LinkedIn by managers, founders and colleagues. Shown in full, unedited.",
    relations: {
      managed: "Managed him directly",
      senior: "Was senior to him",
      peer: "Worked on the same team",
      report: "Reported to him",
    } as Record<string, string>,
    more: "Read in full",
    less: "Show less",
    showAll: "Read all recommendations",
  },
  type: {
    label: "Type Design",
    h2a: "Letters shaped",
...
const ar: typeof en = {
  ...
  recs: {
    ...
    h2i: "عملوا معي",
    h2b: ".",
    note: "{n} توصية مكتوبة على لينكد إن من مديرين ومؤسسين وزملاء. معروضة كاملة كما كُتبت.",
    relations: {
      managed: "كان مديره المباشر",
      senior: "كان أعلى منه",
      peer: "زميل في نفس الفريق",
      report: "كان يعمل تحت إدارته",
    },
    more: "اقرأ كاملة",
    less: "إخفاء",
    showAll: "اقرأ كل التوصيات",
  },
  type: {
    label: "تصميم حروف",
    h2a: "حروفٌ تتشكّل",
