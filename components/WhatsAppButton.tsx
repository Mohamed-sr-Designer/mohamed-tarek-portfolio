...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed right-0 top-1/2 z-[65] flex -translate-y-1/2 items-center gap-2 rounded-l-full bg-[#25D366] py-3 pl-4 pr-3 text-black shadow-lg shadow-black/30 transition-all duration-300 hover:pr-5"
    >
